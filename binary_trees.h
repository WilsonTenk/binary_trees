 ...
 * @left: the pointer to left child node
...
/**
 * struct levelorder_queue_s - Level order traversal line
...
void binarytree_postorder(const binary_tree_t *tree, void (*func)(int));
